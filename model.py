...
# ── Node metadata ─────────────────────────────────────────────────────────────
NODE_META = {
    1:  {"name": "Criminal law burden of proof",        "short": "Burden of proof",       "type": "constraint"},
    2:  {"name": "Serious violence / violent history",   "short": "Violent history",        "type": "risk"},
    3:  {"name": "Validated psychopathy (PCL-R)",        "short": "Psychopathy (PCL-R)",    "type": "risk"},
    4:  {"name": "Sexual offence profile (Static-99R)",  "short": "Sexual offence",         "type": "risk"},
    5:  {"name": "Culturally invalid risk tools",        "short": "Invalid risk tools",     "type": "distortion"},
    6:  {"name": "Ineffective assistance of counsel",    "short": "Ineffective counsel",    "type": "distortion"},
    7:  {"name": "Bail-denial → wrongful guilty plea",   "short": "Bail-denial cascade",    "type": "distortion"},
    8:  {"name": "King credibility impeachment",         "short": "King impeachment",       "type": "distortion"},
    9:  {"name": "FASD — dual factor node",              "short": "FASD",                   "type": "dual"},
    10: {"name": "Intergenerational trauma",             "short": "Intergenerational trauma","type": "mitigation"},
    11: {"name": "Absence of culturally grounded treatment","short": "No cultural treatment","type": "distortion"},
    12: {"name": "Judicial misapplication of Gladue tetrad","short": "Gladue misapplication","type": "distortion"},
    13: {"name": "Gaming risk detector",                 "short": "Gaming risk",            "type": "special"},
    14: {"name": "Over-policing & epistemic contamination","short": "Over-policing",        "type": "distortion"},
    15: {"name": "Temporal distortion",                  "short": "Temporal distortion",    "type": "distortion"},
    16: {"name": "Interjurisdictional tariff effects",   "short": "Tariff disparities",     "type": "distortion"},
    17: {"name": "Collider bias",                        "short": "Collider bias",          "type": "distortion"},
    18: {"name": "Dynamic risk factors",                 "short": "Dynamic risk",           "type": "risk"},
    19: {"name": "Absence of rehabilitative progress",   "short": "No rehabilitation",      "type": "distortion"},
    20: {"name": "Dangerous offender designation risk",  "short": "DO designation risk",    "type": "output"},
}
