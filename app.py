...
/* ── Page content max-width and padding ── */
.block-container {
...
/* ── Tab bar — thicker active indicator, more breathing room ── */
...
/* ── Profile sliders — navy track, white thumb ── */
div[data-testid="stSlider"][aria-label="Age at sentencing"] > div > div > div > div,
div[data-testid="stSlider"][aria-label="PCL-R score"] > div > div > div > div,
div[data-testid="stSlider"][aria-label="Static-99R score"] > div > div > div > div,
div[data-testid="stSlider"][aria-label="Pre-trial detention (days)"] > div > div > div > div {
  background: #1B2A4A !important;
  height: 6px !important;
  border-radius: 4px !important;
}
div[data-testid="stSlider"][aria-label="Age at sentencing"] > div > div > div > div > div,
div[data-testid="stSlider"][aria-label="PCL-R score"] > div > div > div > div > div,
div[data-testid="stSlider"][aria-label="Static-99R score"] > div > div > div > div > div,
div[data-testid="stSlider"][aria-label="Pre-trial detention (days)"] > div > div > div > div > div {
  background: white !important;
  border: 2.5px solid #1B2A4A !important;
  box-shadow: 0 1px 5px rgba(27,42,74,0.25) !important;
...
[data-testid="stDownloadButton"] > button:hover {
  ...
  box-shadow: 0 3px 8px rgba(27,42,74,0.25) !important;
}
...
/* ── Horizontal rule ── */
hr { border-color: #EBE9E3 !important; margin: 1.2rem 0 !important; }
...
"""
    ...
    st.markdown(
        ...
        "P.A.R.V.I.S &nbsp;·&nbsp; Ethical AI Initiative &nbsp;·&nbsp; University of London "
        "&nbsp;·&nbsp; Jeinis Patel, PhD Candidate and Barrister &nbsp;·&nbsp; "
